      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">DeshiPlate AI</span>
            </div>
            <p className="text-gray-400 text-sm mb-4">
              Your intelligent companion for Bangladeshi food recognition and personalized nutrition. AI-powered insights tailored to your health profile for a smarter, healthier lifestyle.
            </p>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 text-sm">
            ...
            <Link href="/cookies" className="text-gray-400 hover:text-orange-500 transition-colors">Cookie Policy</Link>
          </div>
        </div>
      </div>
    </footer>
