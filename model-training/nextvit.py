...
@register_model
def nextvit_small(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    # Remove pretrained_cfg and pretrained_cfg_overlay from kwargs before passing to NextViT
...
@register_model
def nextvit_base(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    kwargs.pop('pretrained_cfg', None)
    kwargs.pop('pretrained_cfg_overlay', None)
...
@register_model
def nextvit_large(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    kwargs.pop('pretrained_cfg', None)
    kwargs.pop('pretrained_cfg_overlay', None)
